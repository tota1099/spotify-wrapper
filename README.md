...
```sh
$ npm install spotify-wrapper-renan --save
```
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/tota1099/spotify-wrapper/tags).

## Authors

| ![Renan Porto](https://avatars2.githubusercontent.com/u/12802340?s=150&v=4)|
|:---------------------:|
|  [Renan Porto](https://github.com/tota1099/)   |

See also the list of [contributors](https://github.com/tota1099/spotify-wrapper/contributors) who participated in this project.
